...
def get_pipeline(
    ...
    dvc_repo_url = ParameterString(
        name="DVCRepoURL",
        default_value="codecommit::us-west-2://sagemaker-intel-emlo"
        # 
    )
    ...
    input_dataset = ParameterString(
        ...
        default_value="s3://sagemaker-us-west-2-350104937619/intel.zip"
    )
    ...
    image_uri='350104937619.dkr.ecr.us-west-2.amazonaws.com/emlo:infer',
    role=role,
    ...
    sagemaker_session=pipeline_session,
    role=role,
    image_uri='350104937619.dkr.ecr.us-west-2.amazonaws.com/emlo:train',
    instance_count=1,
